...
//     // ------------------------------------------------------------------------
//     // const [image_aysnc, setimage_aysnc] = useState(null);
...
//                 if (details.length > 0) {
//                     // setimage_aysnc(details[0].user_image);
//                     // setUser_Id(details[0].user_id);
//                     // setdata1(details);
//                 } else {
...
//     };
//     // -------------------------------------------------------------------------------
// // console.log('image',image_aysnc,'id',user_Id)
...
//     //         // Add image to new details
//     //         const updatedDetails = { ...newDetails };


//     //         // Save new user details
//     //         await AsyncStorage.setItem('user_details', JSON.stringify(updatedDetails));
...
//         try {
//             const response = await fetch('https://demo.cogentecommerce.com/api/view_data_api.php?view=country');
...
//         try {
//             const response = await fetch(`https://demo.cogentecommerce.com/api/view_data_api.php?view=city&country_id=${country_id}`);
//             const result = await response.json();
//             if (result && result.msg) {
...
//         try {
//             const url = `https://demo.cogentecommerce.com/api/user_api.php?user=update-profile`
//             await fetch(url, {
//                 method: "POST",
//                 headers: {
...
//                         marginTop: -50, alignSelf: 'center', width: responsiveWidth(40), height: responsiveHeight(20), borderRadius: 100, backgroundColor: 'white', shadowColor: "#000",
//                         shadowOffset: {
//                             width: 0,
//                             height: 2,
//                         },
...
//                             <Image style={{ alignSelf: 'center', width: responsiveWidth(40), height: responsiveHeight(20), borderRadius: 100, resizeMode: 'contain' }} source={{ uri: user_image.uri }} />
//                         ) : (
//                             <Image style={{ alignSelf: 'center', width: responsiveWidth(40), height: responsiveHeight(20), borderRadius: 100, resizeMode: 'contain' }} source={{ uri: Image }} />
...
//                         <View style={{ backgroundColor: '#fff', borderRadius: 40, alignSelf: 'center', width: responsiveWidth(8), height: responsiveHeight(4), marginTop: -20 }}>
//                             <Icon style={{ alignSelf: 'center' }} name='edit' color='#000' size={25} />
//                         </View>
//                     </TouchableOpacity>
//                 </Animatable.View>
...
//                     <Text style={{ fontSize: responsiveFontSize(3), color: '#353839', paddingLeft: 10 }}>Edite Profile</Text>
//                 </Animatable.View>

//                 <Formik
//                     initialValues={{ first_name: '', last_name: '', email: '', mobile_no: '', address: '' }}
//                     onSubmit={(values, { resetForm }) => {
//                         update(values)
//                         resetForm();
//                         // updateData(newvaluse)
//                     }}
//                     validateOnMount={true}
//                     validationSchema={user_update_form}>
//                     {({ handleBlur, handleChange, errors, isValid, handleSubmit, touched, values, }) => (

//                         <Animatable.View animation={'slideInLeft'} style={{ flexDirection: 'column', width: responsiveWidth(100), justifyContent: 'space-between', alignSelf: 'center' }}>
...
//                                 }}>
//                                     <View>
//                                         <Text style={{ color: 'white', fontSize: responsiveFontSize(3), textAlign: 'center' }}>Update</Text>
//                                     </View>
//                                 </Animatable.View>
//                             </TouchableOpacity>
//                         </Animatable.View>
