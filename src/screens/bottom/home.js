            ...
            <ScrollView>
                ...
                <View style={{ alignSelf: 'center', margin: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: 'black', fontSize: responsiveFontSize(2.5), textAlign: 'center', margin: 5 }}>info@foreeshop.com</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Icon name='cellphone' size={30} color="gray" />

                        <Text style={{ color: 'black', fontSize: responsiveFontSize(2.5), textAlign: 'center', margin: 5 }}>+92-311-3220024</Text>
                    </View>
                </View>
