            ...
            <ScrollView>
                ...
                <View style={{ alignSelf: 'center', margin: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: 'black', fontSize: responsiveFontSize(2.5), textAlign: 'center', margin: 5 }}>ab.bismillahfabrics@gmail.com</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Icon name='cellphone' size={30} color="gray" />

                            <Text style={{ color: 'black', fontSize: responsiveFontSize(2.5), textAlign: 'center', margin: 5 }}>03319998780 - 03203216788</Text>
